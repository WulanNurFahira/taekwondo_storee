        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          <ul class="navbar-nav">
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">TAEKWONDO FAHIRA<span class="text-black fw-bold">Store</span></h1>
              <h3 class="welcome-sub-text">"Pejuang yang sukses adalah orang biasa, dengan fokus seperti laser."</h3>
            </li>
          </ul>
